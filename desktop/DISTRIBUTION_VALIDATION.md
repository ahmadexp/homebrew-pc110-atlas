...
| Pi native picker, PCB-layer layout, resize/PDF/lifecycle sign-off, upstream supported-image workflow | Not complete: default picker and layer-dialog failures; host became unreachable during PDF check after low-voltage warning; candidate not submitted |
...
| Fix candidate regression and packaging | 23 desktop tests on Mac ARM64 and Linux ARM64, 28 packaging tests, packaged Pi QEMU transport smoke passed; new public release, repin and upstream image validation pending |
| Subsequent 1.0.1 older-baseline ARM64 build | Same DEB passed clean-container install, native/QEMU smoke, four UI exports, reinstall, purge and media preservation on Bookworm, Trixie, Jammy, Noble and Resolute; packaged Pi 5 smoke also passed. 23 desktop and 29 packaging tests passed. No new public release or Pi-Apps submission yet; upstream image checks await fork Actions activation |
